...
![email_notification_cpu](../../assets/images/email_notification_cpu.png)
...
- Click on <b>Consuming processes</b>. The processes (containers) running on the host (node) will be listed. Sort them by `CPU usage` and you will see the culprit, the "hot new service" container. 
    ...
    ![host_consuming_processes](../../assets/images/host_consuming_processes.png)
...
If you look back at Slack, you should have received notifications on the `#carts-support-ops` channel; if not, wait a bit.
  ...
  ![slack_cart_support_ops_problem_open](../../assets/images/slack_carts_support_ops_problem_open.png)

- Click on the link to drill-down to the <b>Problem</b> details

    ![carts_promo_problem](../../assets/images/carts_promo_problem.png)
...
- Getting back into Dynatrace
  - You can look drill-down to <b>Analyze failure rate degradation</b>
    ...
    ![carts_promo_failure_analysis](../../assets/images/carts_promo_failure_analysis.png)
    ...
    - After a few minutes, you will get a message in the #carts-support-ops channel notifying the problem is resolved
        ...
        ![slack_carts_support_ops_problem_resolved](../../assets/images/slack_carts_support_ops_problem_resolved.png)
...
- Look at the `#carts-dev` Slack channel, there should be a problem notification (if not wait a bit).
    ...
    ![slack_carts_dev_problem_open](../../assets/images/slack_carts_dev_problem_open.png)
...
- Seems the currently tested new build is expriencing performance issues. Click on the problem link to drill down into the details.
    ...
    ![carts_dev_problem](../../assets/images/carts_dev_problem.png)

- Click on <b>Analyze response time degradation</b>

    ![carts_dev_response_time_analysis](../../assets/images/carts_dev_response_time_analysis.png)
...
- What we see here:
  ...
  4. Let's get down to code level by clicking on <b>View method hotspots</b>
    ...
    ![carts_dev_method_hotspots](../../assets/images/carts_dev_method_hotspots.png)
...
![drill_down_to_PurePaths](../../assets/images/drill_down_to_PurePaths.png)
...
![carts_dev_purepath](../../assets/images/carts_dev_purepath.png)
...
![carts_dev_rollout_history](../../assets/images/carts_dev_rollout_history.png)
...
![slack_carts_dev_problem_resolved](../../assets/images/slack_carts_dev_problem_resolved.png)
